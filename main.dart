        ...
        child: Container(
          ...
          child: Column(
            ...
            children: <Widget>[
             ...
             Row( children: <Widget>[
               Icon(Icons.settings ,size : 35.0 , color: Color(0xFFF57C00)),
               SizedBox(
                width: 20,
               ),
              Text("Réglages",
            ...
            offset:new Offset(0.0,10.0),) ]),
                 ...
                 child : Icon (Icons.perm_identity , color: Color(0xFFF57C00) , size : 50.0 ,  ),
      ...
      child: Container(
        ...
        child: Container(
          ...
          child: Column(
            ...
            leading: Icon(Icons.map , color: Color(0xFFF57C00)),
             onTap : ()=> Navigator.of(context).push(new MaterialPageRoute( builder :
              (BuildContext context ) => new GeoPage(),))),
                
              SettingsTile(title:'Compte',
                  leading: Icon(Icons.account_circle,color: Color(0xFFF57C00)),
                ...
                SettingsTile(
                  ...
                  leading: Icon(Icons.time_to_leave,color: Color(0xFFF57C00)),onTap : ()=> Navigator.of(context).push(new MaterialPageRoute( builder : (BuildContext context ) => new TrajetPage(),))
                  ),
              SettingsTile(
                  title: 'Sécurité et confidentialité',
                  leading: Icon(Icons.security,color: Color(0xFFF57C00)),
                   onTap : ()=> Navigator.of(context).push(new MaterialPageRoute( builder :
              (BuildContext context ) => new SecurityPage(),))),      
               SettingsTile(title:'Déconnecter', leading: Icon(Icons.exit_to_app ,color:
                Color(0xFFF57C00)), onTap: (){showDialog(barrierDismissible:false , 
               context: context , 
               builder : (context){ return AlertDialog( title: Text("Se déconnecter ?", style: TextStyle( color: Color(0xff739D84),)), 
               actions: <Widget> [ 
                 FlatButton ( child: Text ('Oui', style: TextStyle( color: Color(0xFFF57C00),)), onPressed:(){Navigator.pop(context);}),
